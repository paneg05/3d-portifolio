	...
	return (
		<>
			...
			<div className="w-full flex">
				...
				>
					Os projetos a seguir demonstram minhas habilidades através
					de exemplos do meu trabalho. Cada projeto é descrito com
					links para o repositorio de código contendo demonstrações.
					Isto reflete minhas habilidades para resolver problemas
					complexos, trabalhar com diferentes tecnologias e gerenciar
