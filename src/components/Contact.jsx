...
//template_iiby0ma  service_exjk2cj  5Tm5Zuq_7nb1q1ZFK
const Contact = () => {
		...
		emailjs
			.send(
				...
				"template_iiby0ma",
				{
					...
					to_email: "aluncard6@gmail.com",
					messagem: form.message,
				},
				"5Tm5Zuq_7nb1q1ZFK"
			)
			.then(
				() => {
					setLoading(false);
					alert("Obrigado ! retornarei o mais breve possivel !");
					setForm({
						name: "",
						email: "",
						message: "",
		...
		<div className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
			...
			>
              ...
              border-none font-medium"
					...
					<button
						type="submit"
						className="bg-tertiary py-3 px-8 outline-none w-fit text-white font-bold shadow-primary shadow-md
            rounded-xl"
					>
